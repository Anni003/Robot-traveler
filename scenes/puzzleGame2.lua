...
-- 1 строка
local imgPart1 = display.newImageRect( "puzzles folder/img-parts-for-puz-2/image_part_001.jpg", 180, 159 )
imgPart1.x = 743 + 180 - 30
imgPart1.y = 104 + 318 + 30
sceneGroup:insert( imgPart1 ) -- координаты x,y (1,1)

local imgPart2 = display.newImageRect( "puzzles folder/img-parts-for-puz-2/image_part_002.jpg", 180, 159 )
imgPart2.x = 743 - 30
imgPart2.y = 104 + 30
sceneGroup:insert( imgPart2 ) -- координаты x,y (2,1)--голова

local imgPart3 = display.newImageRect( "puzzles folder/img-parts-for-puz-2/image_part_003.jpg", 180, 159 )
imgPart3.x = 743 + 360 - 30
imgPart3.y = 104 + 159 + 30
sceneGroup:insert( imgPart3 ) -- координаты x,y (3,1)

local imgPart4 = display.newImageRect( "puzzles folder/img-parts-for-puz-2/image_part_004.jpg", 180, 159 )
imgPart4.x = 743 - 30
...
local imgPart5 = display.newImageRect( "puzzles folder/img-parts-for-puz-2/image_part_005.jpg", 180, 159 )
imgPart5.x = 743 + 360 -30
imgPart5.y = 104+ 30
sceneGroup:insert( imgPart5 ) -- координаты x,y (2,2)

local imgPart6 = display.newImageRect( "puzzles folder/img-parts-for-puz-2/image_part_006.jpg", 180, 159 )
imgPart6.x = 743 - 30
imgPart6.y = 104 + 159 + 30
sceneGroup:insert( imgPart6 ) -- координаты x,y (3,2)

local imgPart7 = display.newImageRect( "puzzles folder/img-parts-for-puz-2/image_part_007.jpg", 180, 159 )
imgPart7.x = 743 + 180 - 30
imgPart7.y = 104 + 477 + 30
sceneGroup:insert( imgPart7 ) -- координаты x,y (1,3)

local imgPart8 = display.newImageRect( "puzzles folder/img-parts-for-puz-2/image_part_008.jpg", 180, 159 )
...
local imgPart9 = display.newImageRect( "puzzles folder/img-parts-for-puz-2/image_part_009.jpg", 180, 159 )
imgPart9.x = 743 + 360 - 30
imgPart9.y = 104 + 318 + 30
sceneGroup:insert( imgPart9 ) -- координаты x,y (3,3)

local imgPart10 = display.newImageRect( "puzzles folder/img-parts-for-puz-2/image_part_010.jpg", 180, 159 )
imgPart10.x = 743 + 180 - 30
imgPart10.y = 104 + 30
sceneGroup:insert( imgPart10 ) -- координаты x,y (1,4)

local imgPart11 = display.newImageRect( "puzzles folder/img-parts-for-puz-2/image_part_011.jpg", 180, 159 )
imgPart11.x = 743 - 30
imgPart11.y = 104 + 477 + 30
sceneGroup:insert( imgPart11 ) -- координаты x,y (2,4)

local imgPart12 = display.newImageRect( "puzzles folder/img-parts-for-puz-2/image_part_012.jpg", 180, 159 )
