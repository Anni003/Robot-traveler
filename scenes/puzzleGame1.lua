...
-- 1 строка
local imgPart3 = display.newImageRect( "puzzles folder/img-parts-for-puz-1/image_part_003.jpg", 210, 185 )
imgPart3.x = 1124
imgPart3.y = 414
sceneGroup:insert( imgPart3 ) -- координаты x,y (1,1)

local imgPart7 = display.newImageRect( "puzzles folder/img-parts-for-puz-1/image_part_007.jpg", 210, 185 )
imgPart7.x = 1334
imgPart7.y = 414
sceneGroup:insert( imgPart7 ) -- координаты x,y (2,1)--голова

local imgPart10 = display.newImageRect( "puzzles folder/img-parts-for-puz-1/image_part_010.jpg", 210, 185 )
imgPart10.x = 1544
imgPart10.y = 414
sceneGroup:insert( imgPart10 ) -- координаты x,y (3,1)

local imgPart2 = display.newImageRect( "puzzles folder/img-parts-for-puz-1/image_part_002.jpg", 210, 185 )
imgPart2.x = 1754
imgPart2.y = 414
...
local imgPart9 = display.newImageRect( "puzzles folder/img-parts-for-puz-1/image_part_009.jpg", 210, 185 )
imgPart9.x = 1124
imgPart9.y = 599
sceneGroup:insert( imgPart9 ) -- координаты x,y (2,2)

local imgPart5 = display.newImageRect( "puzzles folder/img-parts-for-puz-1/image_part_005.jpg", 210, 185 )
imgPart5.x = 1334
imgPart5.y = 599
sceneGroup:insert( imgPart5 ) -- координаты x,y (3,2)

local imgPart12 = display.newImageRect( "puzzles folder/img-parts-for-puz-1/image_part_012.jpg", 210, 185 )
imgPart12.x = 1544
imgPart12.y = 599
sceneGroup:insert( imgPart12 ) -- координаты x,y (1,3)

local imgPart8 = display.newImageRect( "puzzles folder/img-parts-for-puz-1/image_part_008.jpg", 210, 185 )
imgPart8.x = 1754
imgPart8.y = 599
...
local imgPart4 = display.newImageRect( "puzzles folder/img-parts-for-puz-1/image_part_004.jpg", 210, 185 )
imgPart4.x = 1124
imgPart4.y = 784
sceneGroup:insert( imgPart4 ) -- координаты x,y (3,3)

local imgPart1 = display.newImageRect( "puzzles folder/img-parts-for-puz-1/image_part_001.jpg", 210, 185 )
imgPart1.x = 1334
imgPart1.y = 784
sceneGroup:insert( imgPart1 ) -- координаты x,y (1,4)

local imgPart6 = display.newImageRect( "puzzles folder/img-parts-for-puz-1/image_part_006.jpg", 210, 185 )
imgPart6.x = 1544
imgPart6.y = 784
sceneGroup:insert( imgPart6 ) -- координаты x,y (2,4)

local imgPart11 = display.newImageRect( "puzzles folder/img-parts-for-puz-1/image_part_011.jpg", 210, 185 )
imgPart11.x = 1754
imgPart11.y = 784
